...
<div class="my-8">
    <h2 class="text-2xl font-bold md:text-3xl mb-6">Crear Nueva Pregunta</h2>
    ...
    <form action="{{ route('questions.store') }}" method="POST" class="space-y-6">
        ...
        <div class="flex gap-4">
            ...
            <a
                href="{{ route('home') }}"
                class="rounded-md bg-gray-600 hover:bg-gray-500 px-6 py-3 text-sm font-semibold text-white cursor-pointer transition-colors"
            >
                Cancelar
            </a>
        </div>
